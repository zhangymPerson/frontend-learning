<template>
  ...
  <div class="page">
    ...
    <section class="card">
      <h3>① 基本状态管理</h3>
      <p class="desc">
        Pinia 中的 state 类似于组件的 data，但可以在任意组件间共享。 使用
        storeToRefs() 解构可以保持响应性。
      </p>
      <div class="demo-area">
        ...
        <div class="counter-actions">
          <button @click="counterStore.decrement()">- {{ step }}</button>
          <button @click="counterStore.increment()">+ {{ step }}</button>
    ...
    <section class="card">
      ...
      <div class="demo-area">
        ...
        <button @click="counterStore.fetchCount()">随机获取值 (异步)</button>
      </div>
    </section>
